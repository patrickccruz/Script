                  ...
                  <form class="row g-3 needs-validation" novalidate action="verificar-usuario.php" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Por favor coloque o seu usuario</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Coloque a sua senha!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Não tem uma conta? <a href="criar-usuario.php">Crie a sua conta</a></p>
                    </div>
                  </form>
                </div>
              </div>
